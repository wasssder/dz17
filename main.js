...
const fillList = async () => {
	...
	/*for(const key in user){*/
		list.insertAdjacentHTML(`beforeend`,
			`<div class="post">
				 <img src="heartik.png" class="heart">
					  <img src="post.png" class="in-post">
				 <p class="like"><img src="likeek.png" alt="" srcset="" class="like1">${user["counter1"]}</p><br>
				 <p class="dislike"><img src="dislikeek.png" alt="" srcset="" class="like1">${user["counter2"]}</p>
			</div>
